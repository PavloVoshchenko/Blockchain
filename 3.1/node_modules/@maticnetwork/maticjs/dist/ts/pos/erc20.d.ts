...
export declare class ERC20 extends POSToken {
     ...
     * @memberof ERC20
     */
    withdrawExit(burnTransactionHash: string, option?: IExitTransactionOption): Promise<import("..").ITransactionWriteResult>;
    /**
     * complete withdraw process after checkpoint has been submitted for the block containing burn tx.
     *
     ...
     * @memberof ERC20
     */
    withdrawExitFaster(burnTransactionHash: string, option?: IExitTransactionOption): Promise<import("..").ITransactionWriteResult>;
    /**
